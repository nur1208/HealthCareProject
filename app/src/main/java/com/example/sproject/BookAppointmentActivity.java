...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    TextView tv, dateButton, timeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.txtBookAppTitle);
        dateButton = findViewById(R.id.selectBtnDate);
        timeButton = findViewById(R.id.selectBtnTime);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppointmenExists(username, title + " => " + fullName, address, contact, dateButton.getText().toString(), timeButton.getText().toString()) == 1){
