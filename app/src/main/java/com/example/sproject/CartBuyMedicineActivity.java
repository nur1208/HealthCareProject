...
public class CartBuyMedicineActivity extends AppCompatActivity {
    ...
    TextView tvTotalCast, dateButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton = findViewById(R.id.selectBtnDateBM);
        btnBack = findViewById(R.id.buttonBackCartBM);
        btnCheckout = findViewById(R.id.buttonCheckoutCartBM);
        tvTotalCast = findViewById(R.id.txtTotalCartBM);
        listView = findViewById(R.id.lvDetailsCartBM);
